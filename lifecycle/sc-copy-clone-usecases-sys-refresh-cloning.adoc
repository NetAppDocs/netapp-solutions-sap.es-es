...
La corrupción lógica puede estar causada por errores de software, errores humanos o sabotaje. Desafortunadamente, la corrupción lógica a menudo no puede abordarse con soluciones estándar de alta disponibilidad y recuperación ante desastres. Como resultado, dependiendo de la capa, la aplicación, el sistema de archivos o el almacenamiento donde se produjo la corrupción lógica, a veces no se pueden cumplir los requisitos de tiempo de inactividad máximo y pérdida de datos.
...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf["Recuperación ante desastres de SAP HANA con replicación de almacenamiento"]

link:../backup/hana-dr-anf-data-protection-overview.html["Recuperación ante desastres de SAP HANA con Azure NetApp Files"]
