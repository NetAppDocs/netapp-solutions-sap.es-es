...
* link:../bp/hana-aff-fc-introduction.html["SAP HANA en NetApp All Flash FAS Systems con protocolo SAN Fibre Channel"]
* link:../bp/hana-aff-nfs-introduction.html["SAP HANA en NetApp All Flash FAS Systems con NFS"]
* link:../backup/fsxn-overview.html["SAP HANA en Amazon FSX para ONTAP de NetApp: Backup y recuperación con SnapCenter"]
* link:lama-ansible-introduction.html["Integración de la gestión de entornos SAP de NetApp con Ansible"]
* link:libelle-sc-overview.html["Automatizando las operaciones de copia de sistemas SAP con Libelle SystemCopy (netapp.com)"]
...
| Versión 4.1 | febrero de 2026 | Se añadieron los pasos necesarios para el cifrado de HANA y el SAP local secure store LSS 
|===