...
image::saphana_aff_nfs_image2.png[image2 de saphana AFF]

La figura siguiente muestra un ejemplo del uso de VMware vSphere como capa de virtualización.

image::saphana_aff_nfs_image3.jpg[image3 de saphana AFF]
...
image::saphana_aff_nfs_image4.png[image4 de saphana AFF]
...
image::saphana_aff_nfs_image5.png[image5 de saphana AFF]
...
image::saphana_aff_nfs_image6.jpg[image6 de saphana AFF]
...
image::saphana_aff_nfs_image7.png[image7 de saphana AFF]
...
image::saphana_aff_nfs_image8.png[image8 de saphana AFF]
