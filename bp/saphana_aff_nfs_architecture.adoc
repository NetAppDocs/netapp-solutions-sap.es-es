...
link:saphana_aff_nfs_introduction.html["Anterior: SAP HANA en sistemas All Flash FAS de NetApp con guía de configuración NFS."]
...
image:saphana_aff_nfs_image2.png["Error: Falta la imagen gráfica"]

La figura siguiente muestra un ejemplo del uso de VMware vSphere como capa de virtualización.

image:saphana_aff_nfs_image3.jpg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_nfs_image4.png["Error: Falta la imagen gráfica"]
...
image:saphana_aff_nfs_image5.png["Error: Falta la imagen gráfica"]
...
image:saphana_aff_nfs_image6.jpg["Error: Falta la imagen gráfica"]
...
NOTE: Para obtener información detallada sobre la solución de backup y recuperación de SAP HANA, consulte https://www.netapp.com/us/media/tr-4614.pdf["TR-4614: Backup y recuperación de datos de SAP HANA con SnapCenter"^].
...
image:saphana_aff_nfs_image7.png["Error: Falta la imagen gráfica"]
...
image:saphana_aff_nfs_image8.png["Error: Falta la imagen gráfica"]

link:saphana_aff_nfs_storage_sizing.html["Siguiente: Ajuste de tamaño del almacenamiento."]
