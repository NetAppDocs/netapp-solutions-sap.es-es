...
image:saphana_fas_fc_image5.jpg["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]
...
Para obtener información detallada sobre la solución de recuperación ante desastres SAP HANA con SnapCenter, consulte https://docs.netapp.com/us-en/netapp-solutions-sap/backup/saphana-dr-sr_pdf_link.html["TR-4646: Recuperación ante desastres de SAP HANA con replicación de almacenamiento"^].
