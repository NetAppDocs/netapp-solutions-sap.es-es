...
link:saphana_fas_fc_architecture.html["Anterior: Arquitectura."]
...
link:saphana_fas_fc_infrastructure_setup_and_configuration_overview.html["Siguiente: Instalación y configuración de la infraestructura."]
