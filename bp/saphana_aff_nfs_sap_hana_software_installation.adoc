...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["Anterior: Tamaño del volumen de datos de SAP HANA."]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["Siguiente: Adición de particiones de volumen de datos adicionales."]
