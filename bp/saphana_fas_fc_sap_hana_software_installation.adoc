...
link:saphana_fas_fc_i_o_stack_configuration_for_sap_hana.html["Anterior: Configuración de pila de I/o para SAP HANA."]
...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["Siguiente: Añadir particiones de volúmenes de datos adicionales para sistemas SAP HANA de un solo host."]
