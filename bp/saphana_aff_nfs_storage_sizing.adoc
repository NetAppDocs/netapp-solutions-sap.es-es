...
link:saphana_aff_nfs_architecture.html["Anterior: Arquitectura."]
...
El número mínimo de 12 SSD NVMe para la primera bandeja admite hasta 18 hosts SAP HANA. Una bandeja completamente llena (24 SSD) admite hasta 48 hosts SAP HANA. Lo mismo se aplica a los discos internos de un sistema AFF A800.
...
image:saphana_aff_nfs_image9.jpg["Error: Falta la imagen gráfica"]

link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["Siguiente: Instalación y configuración de la infraestructura."]
