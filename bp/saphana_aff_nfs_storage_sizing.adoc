...
El número mínimo de 12 SSD NVMe para la primera bandeja admite hasta 16 hosts SAP HANA. Una bandeja completamente llena (24 SSD) admite hasta 48 hosts SAP HANA. Lo mismo se aplica a los discos internos de un sistema AFF A800.
