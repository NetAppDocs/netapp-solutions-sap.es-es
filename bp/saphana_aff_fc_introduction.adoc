...
---
= TR-4436: SAP HANA en sistemas AFF de NetApp con el protocolo Fibre Channel
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* AFF A150, AFF A250, AFF A400, AFF A800 y AFF A900
...
image:saphana_aff_fc_image1.png["Error: Falta la imagen gráfica"]
...
Existen varias opciones para conectar el almacenamiento a máquinas virtuales (VM). El preferido es conectar los volúmenes de almacenamiento con NFS directamente desde el sistema operativo invitado. Esta opción se describe en link:https://review.docs.netapp.com/us-en/netapp-solutions-sap_main/bp/saphana_aff_nfs_introduction.html["SAP HANA en sistemas AFF de NetApp con NFS"].
...
link:saphana_aff_fc_architecture.html["Siguiente: Arquitectura."]
