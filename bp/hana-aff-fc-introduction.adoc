...
La familia de productos NetApp AFF/ ASA A-Series ha sido certificada para su uso con SAP HANA en proyectos de integración de centros de datos (TDI) personalizados.
...
* https://help.sap.com/docs/SAP_HANA_PLATFORM/eb3777d5495d46c5b2fa773206bbfb46/0b15a92d554c4941a452c9ca127f8c70.html["Integración del centro de datos a medida de SAP HANA"^]
