...
Para obtener información detallada sobre la solución de copia de seguridad y recuperación de SAP HANA mediante SnapCenter, consulte link:../backup/hana-sc-generic-scope.html["Backup y recuperación de datos de SAP HANA con SnapCenter"^].
