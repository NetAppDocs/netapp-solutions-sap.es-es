...
link:saphana_aff_nfs_infrastructure_setup_and_configuration_overview.html["Anterior: Instalación y configuración de la infraestructura."]
...
link:saphana_aff_nfs_time_synchronization.html["Next: Sincronización de hora."]
