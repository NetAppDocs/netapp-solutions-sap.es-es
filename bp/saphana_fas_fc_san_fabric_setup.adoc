...
link:saphana_fas_fc_infrastructure_setup_and_configuration_overview.html["Anterior: Instalación y configuración de la infraestructura."]
...
image:saphana_fas_fc_image9.png["Error: Falta la imagen gráfica"]
...
link:saphana_fas_fc_time_synchronization.html["Next: Sincronización de hora."]
