...
link:saphana_aff_fc_host_setup.html["Anterior: Configuración del host."]
...
....
link:saphana_aff_fc_sap_hana_software_installation.html["Siguiente: Instalación del software SAP HANA."]
