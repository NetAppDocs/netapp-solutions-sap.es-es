...
NOTE: NetApp ASA no admite NFS como protocolo. NetApp recomienda usar un sistema AFF o FAS adicional para los sistemas de archivos `/hana/shared` y `/lss/shared`.
