...
link:saphana-fas-nfs_architecture.html["Anterior: Arquitectura."]
...
image:saphana-fas-nfs_image9.jpg["Error: Falta la imagen gráfica"]

link:saphana-fas-nfs_infrastructure_setup_and_configuration_overview.html["Siguiente: Instalación y configuración de la infraestructura."]
