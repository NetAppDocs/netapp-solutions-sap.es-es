...
link:saphana_fas_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["Anterior: Se añaden particiones de volúmenes de datos adicionales para sistemas SAP HANA de un solo host."]
...
* TR-4646: Recuperación ante desastres de SAP HANA con replicación de almacenamiento asíncrona mediante el complemento SAP HANA de SnapCenter 4.0
+
...
* Recursos de sistema de almacenamiento FAS de NetApp
...
link:saphana_fas_fc_update_history.html["Siguiente: Historial de actualizaciones."]
