...
. Inicie el asistente de aprovisionamiento de aplicaciones para SAP HANA en System Manager y proporcione la información necesaria. Deben añadirse todos los iniciadores (WWPN) de todos los hosts.
+
image:saphana_aff_fc_image18.jpeg["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]

. Confirmar que el almacenamiento se ha aprovisionado correctamente.


image:saphana_aff_fc_image19.jpeg["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]
