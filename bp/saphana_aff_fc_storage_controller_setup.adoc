...
link:saphana_aff_fc_time_synchronization.html["Anterior: Sincronización de hora."]
...
. Crear grupos iniciadores, volúmenes y LUN dentro de los agregados, como se describe en Crear "<<LUNs and volumes and mapping LUNs to initiator groups>>."
...
image:saphana_aff_fc_image10.png["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image11.png["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image12.jpg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image13.jpeg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image14.jpeg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image15.jpeg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image16.jpg["Error: Falta la imagen gráfica"]
...
image:saphana_aff_fc_image17.jpg["Error: Falta la imagen gráfica"]
...
+
image:saphana_aff_fc_image18.jpeg["Error: Falta la imagen gráfica"]

. Confirmar que el almacenamiento se ha aprovisionado correctamente.


image:saphana_aff_fc_image19.jpeg["Error: Falta la imagen gráfica"]
...
link:saphana_aff_fc_sap_hana_storage_connector_api.html["Siguiente: API del conector de almacenamiento SAP HANA."]
