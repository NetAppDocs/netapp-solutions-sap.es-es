...
Además de las tareas descritas en la secciónlink:hana-aff-nfs-host-setup.html["Configuración de host,"], se deben crear puntos de montaje y entradas adicionales `fstab` para los nuevos volúmenes de datos adicionales y montar los nuevos volúmenes.
...
....
image:saphana_aff_nfs_image18.png["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]
