...
* link:../backup/hana-sc-vmware-smas-scope.html["Protección de datos de SAP HANA y alta disponibilidad con SnapCenter, sincronización activa de SnapMirror y clúster de almacenamiento de VMware Metro"^]
