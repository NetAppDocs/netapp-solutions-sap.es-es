...
link:saphana_aff_fc_introduction.html["Anterior: TR-4436 - SAP HANA en sistemas AFF de NetApp con el protocolo Fibre Channel."]
...
link:saphana_aff_fc_storage_sizing.html["Siguiente: Ajuste de tamaño del almacenamiento."]
