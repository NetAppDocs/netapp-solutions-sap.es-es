...
Un SSD de NVMe (datos) admite hasta 2/5 hosts SAP HANA en función del disco NVMe específico que se utilice.
...
image:saphana_asa_fc_image8a.png["Proceso de dimensionamiento SAP HANA"]
