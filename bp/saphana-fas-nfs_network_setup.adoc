...
link:saphana-fas-nfs_infrastructure_setup_and_configuration_overview.html["Anterior: Instalación y configuración de la infraestructura."]
...
link:saphana-fas-nfs_time_synchronization.html["Next: Sincronización de hora."]
