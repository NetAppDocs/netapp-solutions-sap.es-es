...
link:saphana_fas_fc_time_synchronization.html["Anterior: Sincronización de hora."]
...
El uso de NetApp Volume Encryption (NVE) es compatible con SAP HANA.
...
link:saphana_fas_fc_sap_hana_storage_connector_api.html["Siguiente: API del conector de almacenamiento SAP HANA."]
