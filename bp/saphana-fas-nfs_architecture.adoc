...
image:saphana-fas-nfs_image3.jpg["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]
...
image:saphana-fas-nfs_image6.jpg["Figura que muestra el cuadro de diálogo de entrada/salida o que representa el contenido escrito"]
