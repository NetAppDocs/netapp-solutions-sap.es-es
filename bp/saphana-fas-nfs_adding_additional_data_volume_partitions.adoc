...
link:saphana-fas-nfs_sap_hana_software_installation.html["Anterior: Instalación del software SAP HANA."]A partir de SAP HANA 2.0 SPS4, puede configurar particiones de volúmenes de datos adicionales, lo que le permite configurar dos o más volúmenes para el volumen de datos de una base de datos de inquilino SAP HANA. También puede escalar más allá de los límites de tamaño y rendimiento de un único volumen.
...
link:saphana-fas-nfs_where_to_find_additional_information.html["Siguiente: Dónde encontrar información adicional."]
