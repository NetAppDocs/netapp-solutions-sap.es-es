...
Los diferentes modelos de la familia de productos ASA pueden combinarse y emparejarse en la capa de almacenamiento para permitir el crecimiento y las distintas necesidades de rendimiento y capacidad. El número máximo de hosts SAP HANA que se pueden conectar al sistema de almacenamiento se define según los requisitos de rendimiento de SAP HANA y el modelo de controladora de NetApp utilizado. El número de bandejas de discos necesarias solo está determinado por los requisitos de capacidad y rendimiento de los sistemas SAP HANA.
...
image:saphana_asa_fc_image2a.png["Ocho hosts SAP HANA conectados a un par de alta disponibilidad de almacenamiento"]
...
image:saphana_asa_fc_image3a.png["Hosts SAP HANA adicionales conectados a un par de alta disponibilidad de almacenamiento"]

Independientemente del sistema ASA puesto en marcha, el entorno SAP HANA también puede escalarse añadiendo controladoras de almacenamiento certificadas para cumplir con la densidad de nodos deseada, como se muestra en la siguiente figura.

image:saphana_asa_fc_image4a.png["Añadir un par de alta disponibilidad de almacenamiento adicional"]
...
image:saphana_asa_fc_image5a.png["Complemento SAP HANA de SnapCenter"]
...
Para obtener información detallada acerca de la solución de backup y recuperación de SAP HANA, consulte link:../backup/hana-sc-vmware-smas-scope.html["Protección de datos de SAP HANA y alta disponibilidad con SnapCenter, sincronización activa de SnapMirror y clúster de almacenamiento de VMware Metro"^].


NOTE: Al momento de la creación de este documento, SnapCenter para ASA solo admite máquinas virtuales basadas en VMware que utilizan VMDK como almacenamiento.
...
image:saphana_asa_fc_image6a.png["Descripción general de la replicación de almacenamiento de SnapMirror"]
