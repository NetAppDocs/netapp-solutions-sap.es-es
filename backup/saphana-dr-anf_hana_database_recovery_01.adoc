...
link:saphana-dr-anf_mount_the_volumes_at_the_target_host.html["Anterior: Monte los volúmenes en el host de destino."]
...
link:saphana-dr-anf_update_history.html["Siguiente: Historial de actualizaciones."]
