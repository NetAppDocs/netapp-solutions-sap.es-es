...
Puede encontrar una descripción más detallada en link:hana-sc-generic-sc-resource-config.html#sap-hana-backup-user-and-sap-hana-user-store-configuration["Configuración específica de recursos de SnapCenter para backups de base de datos SAP HANA"]
