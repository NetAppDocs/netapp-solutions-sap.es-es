...
link:amazon-fsx-backup-replication-with-snapvault_overview.html["Anterior: Descripción general - Backup Replication with SnapVault."]
...
sapcc-hana-svm:PFX_data_mnt00001
            XDP  sapcc-backup-target-zone5:PFX_data_mnt00001
                              Snapmirrored
                                      Idle           -         true    -
....
link:amazon-fsx-add-a-backup-svm-to-snapcenter.html["Siguiente: Añada una SVM de backup a SnapCenter."]
