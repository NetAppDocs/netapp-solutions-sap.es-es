...
link:saphana-br-scs-database-backups.html["Anterior: Backups de base de datos."]
...
image:saphana-br-scs-image94.png["Error: Falta la imagen gráfica"]
...
image:saphana-br-scs-image95.png["Error: Falta la imagen gráfica"]
...
....
link:saphana-br-scs-restore-and-recovery.html["Siguiente: Restauración y recuperación."]
