...
....
Puedes encontrar más información sobre las opciones de implementación de SAP HANA plug-in y la configuración del user store en link:hana-sc-generic-scope.html["Backup y recuperación de datos de SAP HANA con SnapCenter"^].
