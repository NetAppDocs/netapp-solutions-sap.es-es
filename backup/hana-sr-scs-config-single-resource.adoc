...
....
Puede encontrar más información sobre las opciones de implementación del complemento SAP HANA y la configuración del almacén de usuarios en el informe técnico TR-4614: link:hana-sc-generic-scope.html["Backup y recuperación de datos de SAP HANA con SnapCenter"^].
