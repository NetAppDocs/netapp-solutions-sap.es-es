...
link:saphana-dr-anf_disaster_recovery_failover_overview.html["Anterior: Recuperación tras fallos."]
...
....
link:saphana-dr-anf_break_and_delete_replication_peering.html["Siguiente: Rompa y elimine la paridad de replicación."]
