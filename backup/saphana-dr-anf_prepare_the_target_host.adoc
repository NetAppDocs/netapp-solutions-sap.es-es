...
link:saphana-dr-anf_disaster_recovery_testing_overview.html["Anterior: Pruebas de recuperación ante desastres."]
...
....
link:saphana-dr-anf_create_new_volumes_based_on_snapshot_backups_at_the_disaster_recovery_site.html["Siguiente: Creación de nuevos volúmenes basados en backups de snapshots en el sitio de recuperación ante desastres."]
