...
link:saphana-dr-anf_create_new_volumes_based_on_snapshot_backups_at_the_disaster_recovery_site.html["Anterior: Creación de nuevos volúmenes basados en backups de snapshots en el sitio de recuperación ante desastres."]
...
....
link:saphana-dr-anf_hana_database_recovery.html["Siguiente: Recuperación de base de datos DE HANA."]
