...
link:saphana-dr-anf_break_and_delete_replication_peering.html["Anterior: Rompa y elimine la paridad de replicación."]
...
vm-pr1:~ #
....
link:saphana-dr-anf_hana_database_recovery_01.html["Siguiente: Recuperación de base de datos DE HANA."]
