...
link:saphana-dr-anf_monitoring_anf_cross-region_replication.html["Anterior: Monitorización de la replicación entre regiones de ANF."]
...
link:saphana-dr-anf_prepare_the_target_host.html["Siguiente: Prepare el host de destino."]
