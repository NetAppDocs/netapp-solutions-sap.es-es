...
link:saphana-dr-anf_hana_database_recovery.html["Anterior: Recuperación de base de datos DE HANA."]
...
link:saphana-dr-anf_prepare_the_target_host_01.html["Siguiente: Prepare el host de destino."]
