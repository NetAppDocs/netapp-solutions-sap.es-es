...
link:hana-sc-generic-scope.html["Backup y recuperación de datos de SAP HANA con SnapCenter"]

link:hana-sr-scs-system-replication-overview.html["Replicación de sistemas SAP HANA: Backup y recuperación de datos con SnapCenter"]
