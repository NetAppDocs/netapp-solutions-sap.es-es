...
link:amazon-fsx-snapcenter-configuration.html["Anterior: Configuración de SnapCenter."]
...
hana-1:~ #
....
link:amazon-fsx-backup-of-non-data-volumes.html["Siguiente: Backup de volúmenes que no pertenecen a datos."]
