...
Puedes encontrar información detallada sobre las operaciones de actualización del sistema SAP usando SnapCenter en https://docs.netapp.com/us-en/netapp-solutions-sap/lifecycle/sc-copy-clone-introduction.html["Automatización de las operaciones de copia y clonado del sistema SAP HANA con SnapCenter"].
...
Para las versiones de SnapCenter < 6.2 hay limitaciones que tienes que considerar.
...
Como se menciona en la sección “Pre-requisitos”, para las versiones de SnapCenter < 6.2 el servicio spl de SnapCenter en el host HANA debe reiniciarse usando el comando “systemctl restart spl” para iniciar la limpieza adecuada.
